...
> **Всего: 2183 вопроса в 51 разделе.** Каждый файл содержит не более 20 вопросов; разделы разбиты на части `<раздел>-NN.md` со сквозной нумерацией.
...
| Раздел | Части (по ≤20 вопросов) | Всего |
|--------|--------------------------|------:|
| AI-ассистированная разработка | [ч.1](ai-assisted-dev-01.md) · [ч.2](ai-assisted-dev-02.md) · [ч.3](ai-assisted-dev-03.md) | 51 |
| Промпт-инжиниринг | [ч.1](prompt-engineering-01.md) · [ч.2](prompt-engineering-02.md) · [ч.3](prompt-engineering-03.md) | 54 |
| LLM: основы и устройство | [ч.1](llm-fundamentals-01.md) · [ч.2](llm-fundamentals-02.md) · [ч.3](llm-fundamentals-03.md) | 52 |
| RAG (Retrieval-Augmented Generation) | [ч.1](rag-01.md) · [ч.2](rag-02.md) · [ч.3](rag-03.md) | 51 |
| ИИ-агенты и агентские паттерны | [ч.1](ai-agents-01.md) · [ч.2](ai-agents-02.md) · [ч.3](ai-agents-03.md) | 54 |
| Model Context Protocol (MCP) | [ч.1](mcp-01.md) · [ч.2](mcp-02.md) · [ч.3](mcp-03.md) | 51 |
| Безопасность и оценка LLM | [ч.1](llm-safety-eval-01.md) · [ч.2](llm-safety-eval-02.md) · [ч.3](llm-safety-eval-03.md) | 54 |
