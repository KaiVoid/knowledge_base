...
<!-- original: assets/02-learning-the-language/generics-sample-hierarchy.gif | Иерархия: ArrayList<String> → List<String> → Collection<String> (Oracle) -->
```mermaid
flowchart BT
...
<!-- original: assets/02-learning-the-language/generics-payload-hierarchy.gif | Иерархия PayloadList: три параметризации как подтипы List<String> (Oracle) -->
```mermaid
flowchart BT
...
<!-- original: assets/02-learning-the-language/generics-list-parent.gif | List<Integer> и List<Number> не связаны; общий родитель — List<?> (Oracle) -->
```mermaid
flowchart BT
...
<!-- original: assets/02-learning-the-language/generics-wildcard-subtyping.gif | Иерархия wildcard-подтипов для List с верхними и нижними границами (Oracle) -->
```mermaid
flowchart BT
