...
<!-- original: assets/16-jaxb/jaxb-overview.gif | Архитектурный обзор JAXB: компилятор схемы, генератор схемы, среда выполнения связывания -->
```mermaid
flowchart LR
...
<!-- original: assets/16-jaxb/jaxb-binding-process.gif | Процесс связывания данных JAXB: 7 шагов от XML-схемы до выходного XML-документа -->
```mermaid
flowchart TB
