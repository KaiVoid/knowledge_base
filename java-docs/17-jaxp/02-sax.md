...
<!-- original: none | Авторская схема конвейера SAX; оригинальная фигура на страницах Oracle отсутствует -->
```mermaid
flowchart TB
...
<!-- original: none | Авторская диаграмма последовательности событий ContentHandler; оригинальная фигура на страницах Oracle отсутствует -->
```mermaid
sequenceDiagram
