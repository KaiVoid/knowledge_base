...
<!-- original: assets/26-2d-graphics/fontmetrics.gif | Положение линии верхних выносных элементов, базовой линии и линии нижних выносных элементов (метрики шрифта) -->
```mermaid
flowchart TB
