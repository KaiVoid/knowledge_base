...
<!-- original: none | авторская обзорная схема структуры урока, в оригинале Oracle нет аналогичной диаграммы -->
```mermaid
flowchart TB
    subgraph CL["Классы"]
        A["Объявление класса"]
...
<!-- original: none | авторская блок-схема трёх шагов создания объекта; Oracle показывает память (objects-oneRef.gif), а не последовательность шагов -->
```mermaid
flowchart LR
...
<!-- original: none | авторская схема правил доступа к членам класса; на странице Oracle classvars.html нет фигуры -->
```mermaid
flowchart TB
...
<!-- original: none | авторская классификационная схема вложенных классов; на странице Oracle nested.html нет фигуры -->
```mermaid
flowchart TB
    N["Вложенные классы"]
...
<!-- original: none | авторская классификационная схема видов ссылок на методы; на странице Oracle methodreferences.html нет фигуры -->
```mermaid
flowchart TB
    R["Ссылки на методы"]
