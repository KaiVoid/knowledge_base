...
<!-- original: assets/11-extension-mechanism/jdk-directory-tree.gif | Дерево каталогов JDK с выделенной JRE и каталогом расширений ext/ -->
```mermaid
flowchart TB
    jdk["jdk/"]
...
<!-- original: none | Иерархия загрузчиков классов — авторская схема, в источнике не изображена -->
```mermaid
flowchart TB
