...
<!-- original: none | Авторская схема несовместимости обобщённых типов; в источнике Oracle только текст -->
```mermaid
flowchart TB
...
<!-- original: none | Авторская схема аналогии DMV/Census; в источнике Oracle только текст -->
```mermaid
flowchart TB
...
<!-- original: none | Авторская схема ограниченных wildcards (? extends Shape); в источнике Oracle только текст -->
```mermaid
flowchart TB
    Shape["Shape (Фигура)"]
